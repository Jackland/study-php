...
class ControllerCommonProfile extends Controller {
	...
	public function index() {
		...
		if ((request()->isMethod('POST')) && $this->validateForm()) {
			...
			$this->response->redirect($this->url->link('common/profile', 'user_token=' . session('user_token'), true));
		}
		...
		$data['breadcrumbs'][] = array(
			...
			'href' => $this->url->link('common/profile', 'user_token=' . session('user_token'), true)
		);

		$data['action'] = $this->url->link('common/profile', 'user_token=' . session('user_token'), true);
