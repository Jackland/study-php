...
class ControllerSettingSetting extends Controller {
	...
	public function index() {
        ...
        if (isset($this->error['powered_by'])) {
            $data['error_powered_by'] = $this->error['powered_by'];
        } else {
            $data['error_powered_by'] = '';
        }
		...
		$data['breadcrumbs'][] = array(
			...
			'href' => $this->url->link('setting/setting', 'user_token=' . session('user_token'), true)
		);
		...
		$data['action'] = $this->url->link('setting/setting', 'user_token=' . session('user_token'), true);
        ...
        if (isset($this->request->post['config_powered_by'])) {
            $data['config_powered_by'] = $this->request->post['config_powered_by'];
        } else {
            $data['config_powered_by'] = $this->config->get('config_powered_by');
        }
	...
	protected function validate() {
        ...
        if ((utf8_strlen($this->request->post['config_powered_by']) < 3) || (utf8_strlen($this->request->post['config_powered_by']) > 1024)) {
            $this->error['powered_by'] = $this->language->get('error_powered_by');
        }
