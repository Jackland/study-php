...
class ControllerCustomerCustomField extends Controller {
	...
	public function add() {
		...
		if ((request()->isMethod('POST')) && $this->validateForm()) {
			...
			$this->response->redirect($this->url->link('customer/custom_field', 'user_token=' . session('user_token') . $url, true));
		}
	...
	protected function getList() {
		...
		$data['breadcrumbs'][] = array(
			...
			'href' => $this->url->link('customer/custom_field', 'user_token=' . session('user_token') . $url, true)
		);

		$data['add'] = $this->url->link('customer/custom_field/add', 'user_token=' . session('user_token') . $url, true);
		$data['delete'] = $this->url->link('customer/custom_field/delete', 'user_token=' . session('user_token') . $url, true);
		...
		foreach ($results as $result) {
			...
			$data['custom_fields'][] = array(
				...
				'edit'            => $this->url->link('customer/custom_field/edit', 'user_token=' . session('user_token') . '&custom_field_id=' . $result['custom_field_id'] . $url, true)
			);
		}
		...
		$data['sort_name'] = $this->url->link('customer/custom_field', 'user_token=' . session('user_token') . '&sort=cfd.name' . $url, true);
		$data['sort_location'] = $this->url->link('customer/custom_field', 'user_token=' . session('user_token') . '&sort=cf.location' . $url, true);
		$data['sort_type'] = $this->url->link('customer/custom_field', 'user_token=' . session('user_token') . '&sort=cf.type' . $url, true);
		$data['sort_status'] = $this->url->link('customer/custom_field', 'user_token=' . session('user_token') . '&sort=cf.status' . $url, true);
		$data['sort_sort_order'] = $this->url->link('customer/custom_field', 'user_token=' . session('user_token') . '&sort=cf.sort_order' . $url, true);
		...
		$pagination->url = $this->url->link('customer/custom_field', 'user_token=' . session('user_token') . $url . '&page={page}', true);
	...
	protected function getForm() {
		...
		if (!isset($this->request->get['custom_field_id'])) {
			$data['action'] = $this->url->link('customer/custom_field/add', 'user_token=' . session('user_token') . $url, true);
		} else {
			$data['action'] = $this->url->link('customer/custom_field/edit', 'user_token=' . session('user_token') . '&custom_field_id=' . $this->request->get['custom_field_id'] . $url, true);
		}

		$data['cancel'] = $this->url->link('customer/custom_field', 'user_token=' . session('user_token') . $url, true);

		if (isset($this->request->get['custom_field_id']) && (!request()->isMethod('POST'))) {
