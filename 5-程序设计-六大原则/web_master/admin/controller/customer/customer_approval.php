	...
	public function customer_approval() {
		...
		foreach ($results as $result) {
			$data['customer_approvals'][] = array(
				...
				'approve'        => $this->url->link('customer/customer_approval/approve', 'user_token=' . session('user_token') . '&customer_id=' . $result['customer_id'] . '&type=' . $result['type'], true),
				'deny'           => $this->url->link('customer/customer_approval/deny', 'user_token=' . session('user_token') . '&customer_id=' . $result['customer_id'] . '&type=' . $result['type'], true),
		...
		$pagination->url = $this->url->link('customer/customer_approval/customer_approval', 'user_token=' . session('user_token') . $url . '&page={page}', true);
