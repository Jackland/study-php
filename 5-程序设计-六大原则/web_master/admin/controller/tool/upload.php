...
class ControllerToolUpload extends Controller {
	...
	public function delete() {
		...
		if (isset($this->request->post['selected']) && $this->validateDelete()) {
			...
			$this->response->redirect($this->url->link('tool/upload', 'user_token=' . session('user_token') . $url, true));
		}
	...
	protected function getList() {
		...
		$data['breadcrumbs'][] = array(
			...
			'href' => $this->url->link('tool/upload', 'user_token=' . session('user_token') . $url, true)
		);

		$data['delete'] = $this->url->link('tool/upload/delete', 'user_token=' . session('user_token') . $url, true);
		...
		foreach ($results as $result) {
			$data['uploads'][] = array(
				...
				'download'   => $this->url->link('tool/upload/download', 'user_token=' . session('user_token') . '&code=' . $result['code'] . $url, true)
			);
		}
		...
		$data['sort_name'] = $this->url->link('tool/upload', 'user_token=' . session('user_token') . '&sort=name' . $url, true);
		$data['sort_filename'] = $this->url->link('tool/upload', 'user_token=' . session('user_token') . '&sort=filename' . $url, true);
		$data['sort_date_added'] = $this->url->link('tool/upload', 'user_token=' . session('user_token') . '&sort=date_added' . $url, true);
		...
		$pagination->url = $this->url->link('tool/upload', 'user_token=' . session('user_token') . $url . '&page={page}', true);
