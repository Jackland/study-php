...
class ControllerToolBackup extends Controller {
	public function index() {
		...
		$data['export'] = $this->url->link('tool/backup/export', 'user_token=' . session('user_token'), true);
	...
	public function import() {
		...
		if (!$json) {
			...
			if ($position && !feof($handle)) {
				$json['next'] = str_replace('&amp;', '&', $this->url->link('tool/backup/import', 'user_token=' . session('user_token') . '&import=' . $filename . '&position=' . $position, true));
	...
	public function export() {
		...
		if (!isset($this->request->post['backup'])) {
			session()->set('error', $this->language->get('error_export'));

			$this->response->redirect($this->url->link('tool/backup', 'user_token=' . session('user_token'), true));
