...
class ControllerCatalogManufacturer extends Controller {
	...
	public function add() {
		...
		if ((request()->isMethod('POST')) && $this->validateForm()) {
			...
			$this->response->redirect($this->url->link('catalog/manufacturer', 'user_token=' . session('user_token') . $url, true));
		}
	...
	protected function getList() {
		...
		$data['breadcrumbs'][] = array(
			...
			'href' => $this->url->link('catalog/manufacturer', 'user_token=' . session('user_token') . $url, true)
		);

		$data['add'] = $this->url->link('catalog/manufacturer/add', 'user_token=' . session('user_token') . $url, true);
		$data['delete'] = $this->url->link('catalog/manufacturer/delete', 'user_token=' . session('user_token') . $url, true);
		...
		foreach ($results as $result) {
			$data['manufacturers'][] = array(
				...
				'edit'            => $this->url->link('catalog/manufacturer/edit', 'user_token=' . session('user_token') . '&manufacturer_id=' . $result['manufacturer_id'] . $url, true)
			);
		}
		...
		$data['sort_name'] = $this->url->link('catalog/manufacturer', 'user_token=' . session('user_token') . '&sort=name' . $url, true);
		$data['sort_sort_order'] = $this->url->link('catalog/manufacturer', 'user_token=' . session('user_token') . '&sort=sort_order' . $url, true);
		...
		$pagination->url = $this->url->link('catalog/manufacturer', 'user_token=' . session('user_token') . $url . '&page={page}', true);
	...
	protected function getForm() {
		...
		if (!isset($this->request->get['manufacturer_id'])) {
			$data['action'] = $this->url->link('catalog/manufacturer/add', 'user_token=' . session('user_token') . $url, true);
		} else {
			$data['action'] = $this->url->link('catalog/manufacturer/edit', 'user_token=' . session('user_token') . '&manufacturer_id=' . $this->request->get['manufacturer_id'] . $url, true);
		}

		$data['cancel'] = $this->url->link('catalog/manufacturer', 'user_token=' . session('user_token') . $url, true);
