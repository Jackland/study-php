...
class ControllerCatalogAttribute extends Controller {
	...
	public function add() {
		...
		if ((request()->isMethod('POST')) && $this->validateForm()) {
			...
			$this->response->redirect($this->url->link('catalog/attribute', 'user_token=' . session('user_token') . $url, true));
		}
	...
	protected function getList() {
		...
		$data['breadcrumbs'][] = array(
			...
			'href' => $this->url->link('catalog/attribute', 'user_token=' . session('user_token') . $url, true)
		);

		$data['add'] = $this->url->link('catalog/attribute/add', 'user_token=' . session('user_token') . $url, true);
		$data['delete'] = $this->url->link('catalog/attribute/delete', 'user_token=' . session('user_token') . $url, true);
		...
		foreach ($results as $result) {
			$data['attributes'][] = array(
				...
				'edit'            => $this->url->link('catalog/attribute/edit', 'user_token=' . session('user_token') . '&attribute_id=' . $result['attribute_id'] . $url, true)
			);
		}
		...
		$data['sort_name'] = $this->url->link('catalog/attribute', 'user_token=' . session('user_token') . '&sort=ad.name' . $url, true);
		$data['sort_attribute_group'] = $this->url->link('catalog/attribute', 'user_token=' . session('user_token') . '&sort=attribute_group' . $url, true);
		$data['sort_sort_order'] = $this->url->link('catalog/attribute', 'user_token=' . session('user_token') . '&sort=a.sort_order' . $url, true);
		...
		$pagination->url = $this->url->link('catalog/attribute', 'user_token=' . session('user_token') . $url . '&page={page}', true);
	...
	protected function getForm() {
		...
		if (!isset($this->request->get['attribute_id'])) {
			$data['action'] = $this->url->link('catalog/attribute/add', 'user_token=' . session('user_token') . $url, true);
		} else {
			$data['action'] = $this->url->link('catalog/attribute/edit', 'user_token=' . session('user_token') . '&attribute_id=' . $this->request->get['attribute_id'] . $url, true);
		}

		$data['cancel'] = $this->url->link('catalog/attribute', 'user_token=' . session('user_token') . $url, true);

		if (isset($this->request->get['attribute_id']) && (!request()->isMethod('POST'))) {
