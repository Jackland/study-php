...
class ControllerCustomerpartnerInformation extends Controller {
	...
	public function index() {
		...
		$data['breadcrumbs'][] = array(
			...
			'href' => $this->url->link('customerpartner/information', 'user_token=' . session('user_token') . $url, true)
		);
		...
		foreach ($results as $result) {
			$data['informations'][] = array(
				...
				'edit'        => $this->url->link('catalog/information/edit', 'user_token=' . session('user_token') . '&information_id=' . $result['information_id'] . '&mpcheck=1' . $url, true),
				'delete'      => $this->url->link('customerpartner/information/delete', 'user_token=' . session('user_token') . '&information_id=' . $result['information_id'] . $url, true)
			);
		}
		...
		$data['sort_name'] = $this->url->link('customerpartner/information', 'user_token=' . session('user_token') . '&sort=name' . $url, true);
		$data['sort_sort_order'] = $this->url->link('customerpartner/information', 'user_token=' . session('user_token') . '&sort=sort_order' . $url, true);
		...
		$pagination->url = $this->url->link('customerpartner/information', 'user_token=' . session('user_token') . $url . '&page={page}', true);
