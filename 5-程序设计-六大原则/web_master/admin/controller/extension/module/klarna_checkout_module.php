...
class ControllerExtensionModuleKlarnaCheckoutModule extends Controller {
	...
	public function index() {
		...
		$data['breadcrumbs'][] = array(
			...
			'href' => $this->url->link('extension/module/klarna_checkout_module', 'user_token=' . session('user_token'), true)
		);

		$data['action'] = $this->url->link('extension/module/klarna_checkout_module', 'user_token=' . session('user_token'), true);
