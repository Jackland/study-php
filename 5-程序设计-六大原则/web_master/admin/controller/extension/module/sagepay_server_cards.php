...
class ControllerExtensionModuleSagepayServerCards extends Controller {
	...
	public function index() {
		...
		$data['breadcrumbs'][] = array(
			...
			'href' => $this->url->link('extension/module/sagepay_server_cards', 'user_token=' . session('user_token'), true)
		);

		$data['action'] = $this->url->link('extension/module/sagepay_server_cards', 'user_token=' . session('user_token'), true);
