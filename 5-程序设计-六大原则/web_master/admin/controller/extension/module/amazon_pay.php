...
class ControllerExtensionModuleAmazonPay extends Controller {
	...
	public function index() {
		...
		$data['breadcrumbs'][] = array(
			...
			'href' => $this->url->link('extension/module/amazon_pay', 'user_token=' . session('user_token'), true),
			'separator' => ' :: '
		);

		$data['action'] = $this->url->link('extension/module/amazon_pay', 'user_token=' . session('user_token'), true);
