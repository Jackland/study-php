...
class ControllerExtensionModuleGoogleHangouts extends Controller {
	...
	public function index() {
		...
		$data['breadcrumbs'][] = array(
			...
			'href' => $this->url->link('extension/module/google_hangouts', 'user_token=' . session('user_token'), true)
		);

		$data['action'] = $this->url->link('extension/module/google_hangouts', 'user_token=' . session('user_token'), true);
