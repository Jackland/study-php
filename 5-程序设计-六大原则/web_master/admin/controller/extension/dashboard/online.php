...
/**
 * @property ModelExtensionDashboardOnline $model_extension_dashboard_online
...
class ControllerExtensionDashboardOnline extends Controller {
	...
	public function index() {
		...
		$data['breadcrumbs'][] = array(
			...
			'href' => $this->url->link('extension/dashboard/online', 'user_token=' . session('user_token'), true)
		);

		$data['action'] = $this->url->link('extension/dashboard/online', 'user_token=' . session('user_token'), true);
	...
	public function dashboard() {
		...
		$data['online'] = $this->url->link('report/online', 'user_token=' . session('user_token'), true);
