...
class ControllerExtensionDashboardCustomer extends Controller {
	...
	public function index() {
		...
		$data['breadcrumbs'][] = array(
			...
			'href' => $this->url->link('extension/dashboard/customer', 'user_token=' . session('user_token'), true)
		);

		$data['action'] = $this->url->link('extension/dashboard/customer', 'user_token=' . session('user_token'), true);
	...
	public function dashboard() {
		...
		$data['customer'] = $this->url->link('customer/customer', 'user_token=' . session('user_token'), true);
