...
class ControllerExtensionDashboardOrder extends Controller {
	...
	public function index() {
		...
		$data['breadcrumbs'][] = array(
			...
			'href' => $this->url->link('extension/dashboard/order', 'user_token=' . session('user_token'), true)
		);

		$data['action'] = $this->url->link('extension/dashboard/order', 'user_token=' . session('user_token'), true);
	...
	public function dashboard() {
		...
		$data['order'] = $this->url->link('sale/order', 'user_token=' . session('user_token'), true);
