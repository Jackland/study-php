...
/**
 * @property ModelExtensionDashboardChart $model_extension_dashboard_chart
...
class ControllerExtensionDashboardChart extends Controller {
	...
	public function index() {
		...
		$data['breadcrumbs'][] = array(
			...
			'href' => $this->url->link('extension/dashboard/chart', 'user_token=' . session('user_token'), true)
		);

		$data['action'] = $this->url->link('extension/dashboard/chart', 'user_token=' . session('user_token'), true);
