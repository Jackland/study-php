...
/**
 * @property ModelExtensionDashboardMap $model_extension_dashboard_map
...
class ControllerExtensionDashboardMap extends Controller {
	...
	public function index() {
		...
		$data['breadcrumbs'][] = array(
			...
			'href' => $this->url->link('extension/dashboard/map', 'user_token=' . session('user_token'), true)
		);

		$data['action'] = $this->url->link('extension/dashboard/map', 'user_token=' . session('user_token'), true);
