...
/**
 * @property ModelExtensionFraudMaxMind $model_extension_fraud_maxmind
...
class ControllerExtensionFraudMaxMind extends Controller {
	...
	public function index() {
		...
		$data['breadcrumbs'][] = array(
			...
			'href' => $this->url->link('extension/fraud/maxmind', 'user_token=' . session('user_token'), true)
		);

		$data['action'] = $this->url->link('extension/fraud/maxmind', 'user_token=' . session('user_token'), true);
