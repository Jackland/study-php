...
/**
 * @property ModelExtensionFraudFraudLabsPro $model_extension_fraud_fraudlabspro
...
class ControllerExtensionFraudFraudLabsPro extends Controller {
	...
	public function index() {
		...
		$data['breadcrumbs'][] = array(
			...
			'href' => $this->url->link('extension/fraud/fraudlabspro', 'user_token=' . session('user_token'), true)
		);

		$data['action'] = $this->url->link('extension/fraud/fraudlabspro', 'user_token=' . session('user_token'), true);
