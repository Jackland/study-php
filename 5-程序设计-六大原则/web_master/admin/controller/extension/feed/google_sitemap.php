...
class ControllerExtensionFeedGoogleSitemap extends Controller {
	...
	public function index() {
		...
		$data['breadcrumbs'][] = array(
			...
			'href' => $this->url->link('extension/feed/google_sitemap', 'user_token=' . session('user_token'), true)
		);

		$data['action'] = $this->url->link('extension/feed/google_sitemap', 'user_token=' . session('user_token'), true);
