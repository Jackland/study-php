...
class ControllerExtensionExtensionModule extends Controller {
	...
	public function install() {
		...
		if ($this->validate()) {
			...
			session()->set('error', $this->error['warning']);
		}
	...
	protected function getList() {
		$data['text_layout'] = sprintf($this->language->get('text_layout'), $this->url->link('design/layout', 'user_token=' . session('user_token'), true));
			...
			foreach ($files as $file) {
				...
				foreach ($modules as $module) {
					...
					$module_data[] = array(
						...
						'edit'      => $this->url->link('extension/module/' . $extension, 'user_token=' . session('user_token') . '&module_id=' . $module['module_id'], true),
						'delete'    => $this->url->link('extension/extension/module/delete', 'user_token=' . session('user_token') . '&module_id=' . $module['module_id'], true)
					);
				}
				...
				$data['extensions'][] = array(
					...
					'module'    => $module_data,
					'install'   => $this->url->link('extension/extension/module/install', 'user_token=' . session('user_token') . '&extension=' . $extension, true),
					'uninstall' => $this->url->link('extension/extension/module/uninstall', 'user_token=' . session('user_token') . '&extension=' . $extension, true),
					'installed' => in_array($extension, $extensions),
					'edit'      => $this->url->link('extension/module/' . $extension, 'user_token=' . session('user_token'), true)
				);
			}
		}
