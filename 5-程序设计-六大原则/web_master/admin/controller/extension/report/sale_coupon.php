...
/**
 * @property ModelExtensionReportCoupon $model_extension_report_coupon
...
class ControllerExtensionReportSaleCoupon extends Controller {
	public function index() {
		...
		$data['breadcrumbs'][] = array(
			...
			'href' => $this->url->link('extension/report/sale_coupon', 'user_token=' . session('user_token'), true)
		);

		$data['action'] = $this->url->link('extension/report/sale_coupon', 'user_token=' . session('user_token'), true);
	...
	public function report() {
		...
		foreach ($results as $result) {
			$data['coupons'][] = array(
				...
				'edit'   => $this->url->link('marketing/coupon/edit', 'user_token=' . session('user_token') . '&coupon_id=' . $result['coupon_id'], true)
			);
		}
		...
		$pagination->url = $this->url->link('report/report', 'user_token=' . session('user_token') . '&code=sale_coupon' . $url . '&page={page}', true);
