...
/**
 * @property ModelExtensionReportReturn $model_extension_report_return
...
class ControllerExtensionReportSaleReturn extends Controller {
	public function index() {
		...
		$data['breadcrumbs'][] = array(
			...
			'href' => $this->url->link('extension/report/sale_return', 'user_token=' . session('user_token'), true)
		);

		$data['action'] = $this->url->link('extension/report/sale_return', 'user_token=' . session('user_token'), true);
	...
	public function report() {
		...
		$pagination->url = $this->url->link('report/report', 'user_token=' . session('user_token') . '&code=sale_return' . $url . '&page={page}', true);
