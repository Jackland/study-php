...
class ControllerExtensionReportProductPurchased extends Controller {
	public function index() {
		...
		$data['breadcrumbs'][] = array(
			...
			'href' => $this->url->link('extension/report/product_purchased', 'user_token=' . session('user_token'), true)
		);

		$data['action'] = $this->url->link('extension/report/product_purchased', 'user_token=' . session('user_token'), true);
	...
	public function report() {
		...
		$pagination->url = $this->url->link('report/report', 'user_token=' . session('user_token') . '&code=product_purchased' . $url . '&page={page}', true);
