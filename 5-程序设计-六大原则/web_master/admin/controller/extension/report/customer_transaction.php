...
class ControllerExtensionReportCustomerTransaction extends Controller {
	public function index() {
		...
		$data['breadcrumbs'][] = array(
			...
			'href' => $this->url->link('extension/report/customer_transaction', 'user_token=' . session('user_token'), true)
		);

		$data['action'] = $this->url->link('extension/report/customer_transaction', 'user_token=' . session('user_token'), true);
	...
	public function report() {
		...
		foreach ($results as $result) {
			$data['customers'][] = array(
				...
				'edit'           => $this->url->link('customer/customer/edit', 'user_token=' . session('user_token') . '&customer_id=' . $result['customer_id'], true)
			);
		}
		...
		$pagination->url = $this->url->link('report/report', 'user_token=' . session('user_token') . '&code=customer_transaction' . $url . '&page={page}', true);
