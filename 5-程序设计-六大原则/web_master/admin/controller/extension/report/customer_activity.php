...
class ControllerExtensionReportCustomerActivity extends Controller {
	public function index() {
		...
		$data['breadcrumbs'][] = array(
			...
			'href' => $this->url->link('extension/report/customer_activity', 'user_token=' . session('user_token'), true)
		);

		$data['action'] = $this->url->link('extension/report/customer_activity', 'user_token=' . session('user_token'), true);
	...
	public function report() {
		...
		foreach ($results as $result) {
			...
			$replace = array(
				$this->url->link('customer/customer/edit', 'user_token=' . session('user_token') . '&customer_id=', true),
				$this->url->link('sale/order/info', 'user_token=' . session('user_token') . '&order_id=', true)
			);
		...
		$pagination->url = $this->url->link('report/report', 'user_token=' . session('user_token') . '&code=customer_activity' . $url . '&page={page}', true);
