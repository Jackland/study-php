...
class ControllerExtensionReportCustomerReward extends Controller {
	public function index() {
		...
		$data['breadcrumbs'][] = array(
			...
			'href' => $this->url->link('extension/report/customer_reward', 'user_token=' . session('user_token'), true)
		);

		$data['action'] = $this->url->link('extension/report/customer_reward', 'user_token=' . session('user_token'), true);
	...
	public function report() {
		...
		$pagination->url = $this->url->link('report/report', 'user_token=' . session('user_token') . '&code=customer_reward' . $url . '&page={page}', true);
