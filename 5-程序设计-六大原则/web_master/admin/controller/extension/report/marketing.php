...
/**
 * @property ModelExtensionReportMarketing $model_extension_report_marketing
...
class ControllerExtensionReportMarketing extends Controller {
	public function index() {
		...
		$data['breadcrumbs'][] = array(
			...
			'href' => $this->url->link('extension/report/marketing', 'user_token=' . session('user_token'), true)
		);

		$data['action'] = $this->url->link('extension/report/marketing', 'user_token=' . session('user_token'), true);
	...
	public function report() {
		...
		foreach ($results as $result) {
			$data['marketings'][] = array(
				...
				'action'   => $this->url->link('marketing/marketing/edit', 'user_token=' . session('user_token') . '&marketing_id=' . $result['marketing_id'], true)
			);
		}
		...
		$pagination->url = $this->url->link('report/report', 'user_token=' . session('user_token') . '&code=marketing' . $url . '&page={page}', true);
