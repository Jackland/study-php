...
/**
 * @property ModelExtensionReportSale $model_extension_report_sale
...
class ControllerExtensionReportSaleShipping extends Controller {
	public function index() {
		...
		$data['breadcrumbs'][] = array(
			...
			'href' => $this->url->link('extension/report/sale_shipping', 'user_token=' . session('user_token'), true)
		);

		$data['action'] = $this->url->link('extension/report/sale_shipping', 'user_token=' . session('user_token'), true);
	...
	public function report() {
		...
		$pagination->url = $this->url->link('report/report', 'user_token=' . session('user_token') . '&code=sale_shipping' . $url . '&page={page}', true);
