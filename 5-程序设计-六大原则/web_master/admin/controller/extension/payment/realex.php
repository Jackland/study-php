...
/**
 * @property ModelExtensionPaymentRealex $model_extension_payment_realex
...
class ControllerExtensionPaymentRealex extends Controller {
	...
	public function index() {
		...
		$data['breadcrumbs'][] = array(
			...
			'href' => $this->url->link('extension/payment/realex', 'user_token=' . session('user_token'), true)
		);

		$data['action'] = $this->url->link('extension/payment/realex', 'user_token=' . session('user_token'), true);
