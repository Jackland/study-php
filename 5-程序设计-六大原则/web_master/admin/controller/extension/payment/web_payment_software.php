...
class ControllerExtensionPaymentWebPaymentSoftware extends Controller {
	...
	public function index() {
		...
		$data['breadcrumbs'][] = array(
			...
			'href' => $this->url->link('extension/payment/web_payment_software', 'user_token=' . session('user_token'), true)
		);

		$data['action'] = $this->url->link('extension/payment/web_payment_software', 'user_token=' . session('user_token'), true);
