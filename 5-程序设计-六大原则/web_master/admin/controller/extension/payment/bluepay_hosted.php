...
/**
 * @property ModelExtensionPaymentBluePayHosted $model_extension_payment_bluepay_hosted
...
class ControllerExtensionPaymentBluePayHosted extends Controller {
	...
	public function index() {
		...
		$data['breadcrumbs'][] = array(
			...
			'href' => $this->url->link('extension/payment/bluepay_hosted', 'user_token=' . session('user_token'), true)
		);

		$data['action'] = $this->url->link('extension/payment/bluepay_hosted', 'user_token=' . session('user_token'), true);
