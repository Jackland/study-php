...
class ControllerExtensionPaymentWechatPay extends Controller {
	...
	public function index() {
		...
		$data['breadcrumbs'][] = array(
			...
			'href' => $this->url->link('extension/payment/wechat_pay', 'user_token=' . session('user_token'), true)
		);

		$data['action'] = $this->url->link('extension/payment/wechat_pay', 'user_token=' . session('user_token'), true);
		...
		if (isset($this->request->post['payment_wechat_pay_poundage'])) {
			$data['payment_wechat_pay_poundage'] = $this->request->post['payment_wechat_pay_poundage'];
		} else {
			$data['payment_wechat_pay_poundage'] = $this->config->get('payment_wechat_pay_poundage');
		}
