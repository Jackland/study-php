...
/**
 * @property ModelExtensionPaymentGlobalpay $model_extension_payment_globalpay
...
class ControllerExtensionPaymentGlobalpay extends Controller {
	...
	public function index() {
		...
		$data['breadcrumbs'][] = array(
			...
			'href' => $this->url->link('extension/payment/globalpay', 'user_token=' . session('user_token'), true)
		);

		$data['action'] = $this->url->link('extension/payment/globalpay', 'user_token=' . session('user_token'), true);
