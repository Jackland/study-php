...
/**
 * @property ModelExtensionPaymentSecureTradingPp $model_extension_payment_securetrading_pp
...
class ControllerExtensionPaymentSecureTradingPp extends Controller {
	...
	public function index() {
		...
		$data['breadcrumbs'][] = array(
			...
			'href' => $this->url->link('extension/payment/securetrading_pp', 'user_token=' . session('user_token'), true)
		);
		...
		$data['action'] = $this->url->link('extension/payment/securetrading_pp', 'user_token=' . session('user_token'), true);
