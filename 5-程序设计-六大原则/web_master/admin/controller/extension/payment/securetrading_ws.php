...
/**
 * @property ModelExtensionPaymentSecureTradingWs $model_extension_payment_securetrading_ws
...
class ControllerExtensionPaymentSecureTradingWs extends Controller {
	...
	public function index() {
		...
		$data['breadcrumbs'][] = array(
			...
			'href' => $this->url->link('extension/payment/securetrading_ws', 'user_token=' . session('user_token'), true)
		);
		...
		$data['action'] = $this->url->link('extension/payment/securetrading_ws', 'user_token=' . session('user_token'), true);
		...
		if ($response) {
			...
			foreach ($csv as $row) {
				$data['transactions'][] = array(
					...
					'order_href' => $this->url->link('sale/order/info', 'user_token=' . session('user_token') . '&order_id=' . $row['orderreference'], true),
