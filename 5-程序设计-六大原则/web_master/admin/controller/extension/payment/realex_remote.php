...
/**
 * @property ModelExtensionPaymentRealexRemote $model_extension_payment_realex_remote
...
class ControllerExtensionPaymentRealexRemote extends Controller {
	...
	public function index() {
		...
		$data['breadcrumbs'][] = array(
			...
			'href' => $this->url->link('extension/payment/realex_remote', 'user_token=' . session('user_token'), true)
		);

		$data['action'] = $this->url->link('extension/payment/realex_remote', 'user_token=' . session('user_token'), true);
