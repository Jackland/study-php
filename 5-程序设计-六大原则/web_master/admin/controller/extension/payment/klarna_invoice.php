...
class ControllerExtensionPaymentKlarnaInvoice extends Controller {
	...
	public function index() {
		...
		$data['breadcrumbs'][] = array(
			...
			'href' => $this->url->link('extension/payment/klarna_invoice', 'user_token=' . session('user_token'), true)
		);

		$data['action'] = $this->url->link('extension/payment/klarna_invoice', 'user_token=' . session('user_token'), true);
		...
		$data['clear'] = $this->url->link('extension/payment/klarna_invoice/clear', 'user_token=' . session('user_token'), true);
	...
	public function clear() {
		...
		$this->response->redirect($this->url->link('extension/payment/klarna_invoice', 'user_token=' . session('user_token'), true));
	}
}