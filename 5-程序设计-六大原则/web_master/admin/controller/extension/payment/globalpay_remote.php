...
/**
 * @property ModelExtensionPaymentGlobalpayRemote $model_extension_payment_globalpay_remote
...
class ControllerExtensionPaymentGlobalpayRemote extends Controller {
	...
	public function index() {
		...
		$data['breadcrumbs'][] = array(
			...
			'href' => $this->url->link('extension/payment/globalpay_remote', 'user_token=' . session('user_token'), true)
		);

		$data['action'] = $this->url->link('extension/payment/globalpay_remote', 'user_token=' . session('user_token'), true);
