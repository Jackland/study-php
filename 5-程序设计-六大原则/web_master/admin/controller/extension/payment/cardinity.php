...
/**
 * @property ModelExtensionPaymentBluepayredirect $model_extension_payment_bluepay_redirect
 * @property ModelExtensionPaymentCardConnect $model_extension_payment_cardconnect
 * @property ModelExtensionPaymentCardinity $model_extension_payment_cardinity
...
class ControllerExtensionPaymentCardinity extends Controller {
	...
	public function index() {
		...
		$data['breadcrumbs'][] = array(
			...
			'href' => $this->url->link('extension/payment/cardinity', 'user_token=' . session('user_token'), true)
		);

		$data['action'] = $this->url->link('extension/payment/cardinity', 'user_token=' . session('user_token'), true);
