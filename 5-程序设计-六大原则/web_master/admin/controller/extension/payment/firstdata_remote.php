...
/**
 * @property ModelExtensionPaymentFirstdataRemote $model_extension_payment_firstdata_remote
...
class ControllerExtensionPaymentFirstdataRemote extends Controller {
	...
	public function index() {
		...
		$data['breadcrumbs'][] = array(
			...
			'href' => $this->url->link('extension/payment/firstdata_remote', 'user_token=' . session('user_token') . '&type=payment', true)
		);

		$data['action'] = $this->url->link('extension/payment/firstdata_remote', 'user_token=' . session('user_token'), true);
