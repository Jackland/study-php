...
class ControllerExtensionTotalLowOrderFee extends Controller {
	...
	public function index() {
		...
		$data['breadcrumbs'][] = array(
			...
			'href' => $this->url->link('extension/total/low_order_fee', 'user_token=' . session('user_token'), true)
		);

		$data['action'] = $this->url->link('extension/total/low_order_fee', 'user_token=' . session('user_token'), true);
