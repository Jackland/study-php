...
class ControllerExtensionThemeDefault extends Controller {
	...
	public function index() {
		...
		$data['breadcrumbs'][] = array(
			...
			'href' => $this->url->link('extension/theme/default', 'user_token=' . session('user_token') . '&store_id=' . $this->request->get['store_id'], true)
		);

		$data['action'] = $this->url->link('extension/theme/default', 'user_token=' . session('user_token') . '&store_id=' . $this->request->get['store_id'], true);
