...
class ControllerMarketplaceModification extends Controller {
	...
	public function delete() {
		...
		if (isset($this->request->post['selected']) && $this->validate()) {
			...
			$this->response->redirect($this->url->link('marketplace/modification', 'user_token=' . session('user_token') . $url, true));
		}
	...
	public function refresh($data = array()) {
		...
		if ($this->validate()) {
			...
			$this->response->redirect($this->url->link(!empty($data['redirect']) ? $data['redirect'] : 'marketplace/modification', 'user_token=' . session('user_token') . $url, true));
		}
	...
	protected function getList() {
		...
		$data['refresh'] = $this->url->link('marketplace/modification/refresh', 'user_token=' . session('user_token') . $url, true);
		$data['clear'] = $this->url->link('marketplace/modification/clear', 'user_token=' . session('user_token') . $url, true);
		$data['delete'] = $this->url->link('marketplace/modification/delete', 'user_token=' . session('user_token') . $url, true);
		...
		foreach ($results as $result) {
			$data['modifications'][] = array(
				...
				'link'            => $result['link'],
				'enable'          => $this->url->link('marketplace/modification/enable', 'user_token=' . session('user_token') . '&modification_id=' . $result['modification_id'], true),
				'disable'         => $this->url->link('marketplace/modification/disable', 'user_token=' . session('user_token') . '&modification_id=' . $result['modification_id'], true),
		...
		$data['sort_name'] = $this->url->link('marketplace/modification', 'user_token=' . session('user_token') . '&sort=name' . $url, true);
		$data['sort_author'] = $this->url->link('marketplace/modification', 'user_token=' . session('user_token') . '&sort=author' . $url, true);
		$data['sort_version'] = $this->url->link('marketplace/modification', 'user_token=' . session('user_token') . '&sort=version' . $url, true);
		$data['sort_status'] = $this->url->link('marketplace/modification', 'user_token=' . session('user_token') . '&sort=status' . $url, true);
		$data['sort_date_added'] = $this->url->link('marketplace/modification', 'user_token=' . session('user_token') . '&sort=date_added' . $url, true);
		...
		$pagination->url = $this->url->link('marketplace/modification', 'user_token=' . session('user_token') . $url . '&page={page}', true);
		...
		$data['clear_log'] = $this->url->link('marketplace/modification/clearlog', 'user_token=' . session('user_token'), true);
