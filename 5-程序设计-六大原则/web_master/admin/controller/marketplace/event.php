...
class ControllerMarketplaceEvent extends Controller {
	...
	public function enable() {
		...
		if (isset($this->request->get['event_id']) && $this->validate()) {
			...
			$this->response->redirect($this->url->link('marketplace/event', 'user_token=' . session('user_token') . $url, true));
		}
	...
	public function getList() {
		...
		$data['breadcrumbs'][] = array(
			...
			'href' => $this->url->link('marketplace/event', 'user_token=' . session('user_token') . $url, true)
		);

		$data['delete'] = $this->url->link('marketplace/event/delete', 'user_token=' . session('user_token') . $url, true);
		...
		foreach ($results as $result) {
			$data['events'][] = array(
				...
				'enable'     => $this->url->link('marketplace/event/enable', 'user_token=' . session('user_token') . '&event_id=' . $result['event_id'] . $url, true),
				'disable'    => $this->url->link('marketplace/event/disable', 'user_token=' . session('user_token') . '&event_id=' . $result['event_id'] . $url, true),
		...
		$data['sort_code'] = $this->url->link('marketplace/event', 'user_token=' . session('user_token') . '&sort=code' . $url, true);
		$data['sort_sort_order'] = $this->url->link('marketplace/event', 'user_token=' . session('user_token') . '&sort=sort_order' . $url, true);
		$data['sort_status'] = $this->url->link('marketplace/event', 'user_token=' . session('user_token') . '&sort=status' . $url, true);
		...
		$pagination->url = $this->url->link('marketplace/event', 'user_token=' . session('user_token') . $url . '&page={page}', true);
