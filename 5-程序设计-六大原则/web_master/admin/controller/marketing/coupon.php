...
class ControllerMarketingCoupon extends Controller {
	...
	public function add() {
		...
		if ((request()->isMethod('POST')) && $this->validateForm()) {
			...
			$this->response->redirect($this->url->link('marketing/coupon', 'user_token=' . session('user_token') . $url, true));
		}
	...
	protected function getList() {
		...
		$data['breadcrumbs'][] = array(
			...
			'href' => $this->url->link('marketing/coupon', 'user_token=' . session('user_token') . $url, true)
		);

		$data['add'] = $this->url->link('marketing/coupon/add', 'user_token=' . session('user_token') . $url, true);
		$data['delete'] = $this->url->link('marketing/coupon/delete', 'user_token=' . session('user_token') . $url, true);
		...
		foreach ($results as $result) {
			$data['coupons'][] = array(
				...
				'edit'       => $this->url->link('marketing/coupon/edit', 'user_token=' . session('user_token') . '&coupon_id=' . $result['coupon_id'] . $url, true)
			);
		}
		...
		$data['sort_name'] = $this->url->link('marketing/coupon', 'user_token=' . session('user_token') . '&sort=name' . $url, true);
		$data['sort_code'] = $this->url->link('marketing/coupon', 'user_token=' . session('user_token') . '&sort=code' . $url, true);
		$data['sort_discount'] = $this->url->link('marketing/coupon', 'user_token=' . session('user_token') . '&sort=discount' . $url, true);
		$data['sort_date_start'] = $this->url->link('marketing/coupon', 'user_token=' . session('user_token') . '&sort=date_start' . $url, true);
		$data['sort_date_end'] = $this->url->link('marketing/coupon', 'user_token=' . session('user_token') . '&sort=date_end' . $url, true);
		$data['sort_status'] = $this->url->link('marketing/coupon', 'user_token=' . session('user_token') . '&sort=status' . $url, true);
		...
		$pagination->url = $this->url->link('marketing/coupon', 'user_token=' . session('user_token') . $url . '&page={page}', true);
	...
	protected function getForm() {
		...
		if (!isset($this->request->get['coupon_id'])) {
			$data['action'] = $this->url->link('marketing/coupon/add', 'user_token=' . session('user_token') . $url, true);
		} else {
			$data['action'] = $this->url->link('marketing/coupon/edit', 'user_token=' . session('user_token') . '&coupon_id=' . $this->request->get['coupon_id'] . $url, true);
		}

		$data['cancel'] = $this->url->link('marketing/coupon', 'user_token=' . session('user_token') . $url, true);

		if (isset($this->request->get['coupon_id']) && (!!request()->isMethod('POST'))) {
	...
	public function history() {
		...
		$pagination->page = $page;
		$pagination->limit = 10;
		$pagination->url = $this->url->link('marketing/coupon/history', 'user_token=' . session('user_token') . '&coupon_id=' . $this->request->get['coupon_id'] . '&page={page}', true);
