...
class ControllerMarketingMarketing extends Controller {
	...
	public function add() {
		...
		if ((request()->isMethod('POST')) && $this->validateForm()) {
			...
			$this->response->redirect($this->url->link('marketing/marketing', 'user_token=' . session('user_token') . $url, true));
		}
	...
	protected function getList() {
		...
		$data['breadcrumbs'][] = array(
			...
			'href' => $this->url->link('marketing/marketing', 'user_token=' . session('user_token') . $url, true)
		);

		$data['add'] = $this->url->link('marketing/marketing/add', 'user_token=' . session('user_token') . $url, true);
		$data['delete'] = $this->url->link('marketing/marketing/delete', 'user_token=' . session('user_token') . $url, true);
		...
		foreach ($results as $result) {
			$data['marketings'][] = array(
				...
				'edit'         => $this->url->link('marketing/marketing/edit', 'user_token=' . session('user_token') . '&marketing_id=' . $result['marketing_id'] . $url, true)
			);
		}
		...
		$data['sort_name'] = $this->url->link('marketing/marketing', 'user_token=' . session('user_token') . '&sort=m.name' . $url, true);
		$data['sort_code'] = $this->url->link('marketing/marketing', 'user_token=' . session('user_token') . '&sort=m.code' . $url, true);
		$data['sort_date_added'] = $this->url->link('marketing/marketing', 'user_token=' . session('user_token') . '&sort=m.date_added' . $url, true);
		...
		$pagination->url = $this->url->link('marketing/marketing', 'user_token=' . session('user_token') . $url . '&page={page}', true);
	...
	protected function getForm() {
		...
		if (!isset($this->request->get['marketing_id'])) {
			$data['action'] = $this->url->link('marketing/marketing/add', 'user_token=' . session('user_token') . $url, true);
		} else {
			$data['action'] = $this->url->link('marketing/marketing/edit', 'user_token=' . session('user_token') . '&marketing_id=' . $this->request->get['marketing_id'] . $url, true);
		}

		$data['cancel'] = $this->url->link('marketing/marketing', 'user_token=' . session('user_token') . $url, true);

		if (isset($this->request->get['marketing_id']) && (!request()->isMethod('POST'))) {
