...
class ControllerSaleVoucherTheme extends Controller {
	...
	public function add() {
		...
		if ((request()->isMethod('POST')) && $this->validateForm()) {
			...
			$this->response->redirect($this->url->link('sale/voucher_theme', 'user_token=' . session('user_token') . $url, true));
		}
	...
	protected function getList() {
		...
		$data['breadcrumbs'][] = array(
			...
			'href' => $this->url->link('sale/voucher_theme', 'user_token=' . session('user_token') . $url, true)
		);

		$data['add'] = $this->url->link('sale/voucher_theme/add', 'user_token=' . session('user_token') . $url, true);
		$data['delete'] = $this->url->link('sale/voucher_theme/delete', 'user_token=' . session('user_token') . $url, true);
		...
		foreach ($results as $result) {
			$data['voucher_themes'][] = array(
				...
				'name'             => $result['name'],
				'edit'             => $this->url->link('sale/voucher_theme/edit', 'user_token=' . session('user_token') . '&voucher_theme_id=' . $result['voucher_theme_id'] . $url, true)
			);
		}
		...
		$data['sort_name'] = $this->url->link('sale/voucher_theme', 'user_token=' . session('user_token') . '&sort=name' . $url, true);
		...
		$pagination->url = $this->url->link('sale/voucher_theme', 'user_token=' . session('user_token') . $url . '&page={page}', true);
	...
	protected function getForm() {
		...
		if (!isset($this->request->get['voucher_theme_id'])) {
			$data['action'] = $this->url->link('sale/voucher_theme/add', 'user_token=' . session('user_token') . $url, true);
		} else {
			$data['action'] = $this->url->link('sale/voucher_theme/edit', 'user_token=' . session('user_token') . '&voucher_theme_id=' . $this->request->get['voucher_theme_id'] . $url, true);
		}

		$data['cancel'] = $this->url->link('sale/voucher_theme', 'user_token=' . session('user_token') . $url, true);

		if (isset($this->request->get['voucher_theme_id']) && (!request()->isMethod('POST'))) {
