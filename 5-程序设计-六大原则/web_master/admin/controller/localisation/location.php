...
class ControllerLocalisationLocation extends Controller {
	...
	public function add() {
		...
		if ((request()->isMethod('POST')) && $this->validateForm()) {
			...
			$this->response->redirect($this->url->link('localisation/location', 'user_token=' . session('user_token') . $url, true));
		}
	...
	protected function getList() {
		...
		$data['breadcrumbs'][] =   array(
			...
			'href' =>  $this->url->link('localisation/location', 'user_token=' . session('user_token') . $url, true)
		);

		$data['add'] = $this->url->link('localisation/location/add', 'user_token=' . session('user_token') . $url, true);
		$data['delete'] = $this->url->link('localisation/location/delete', 'user_token=' . session('user_token') . $url, true);
		...
		foreach ($results as $result) {
			$data['location'][] =   array(
				...
				'edit'        => $this->url->link('localisation/location/edit', 'user_token=' . session('user_token') . '&location_id=' . $result['location_id'] . $url, true)
			);
		}
		...
		$data['sort_name'] = $this->url->link('localisation/location', 'user_token=' . session('user_token') . '&sort=name' . $url, true);
		$data['sort_address'] = $this->url->link('localisation/location', 'user_token=' . session('user_token') . '&sort=address' . $url, true);
		...
		$pagination->url = $this->url->link('localisation/location', 'user_token=' . session('user_token') . $url . '&page={page}', true);
	...
	protected function getForm() {
		...
		if (!isset($this->request->get['location_id'])) {
			$data['action'] = $this->url->link('localisation/location/add', 'user_token=' . session('user_token') . $url, true);
		} else {
			$data['action'] = $this->url->link('localisation/location/edit', 'user_token=' . session('user_token') .  '&location_id=' . $this->request->get['location_id'] . $url, true);
		}

		$data['cancel'] = $this->url->link('localisation/location', 'user_token=' . session('user_token') . $url, true);

		if (isset($this->request->get['location_id']) && (!request()->isMethod('POST'))) {
