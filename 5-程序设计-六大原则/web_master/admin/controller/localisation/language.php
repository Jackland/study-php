...
class ControllerLocalisationLanguage extends Controller {
	...
	public function add() {
		...
		if ((request()->isMethod('POST')) && $this->validateForm()) {
			...
			$this->response->redirect($this->url->link('localisation/language', 'user_token=' . session('user_token') . $url, true));
		}
	...
	protected function getList() {
		...
		$data['breadcrumbs'][] = array(
			...
			'href' => $this->url->link('localisation/language', 'user_token=' . session('user_token') . $url, true)
		);

		$data['add'] = $this->url->link('localisation/language/add', 'user_token=' . session('user_token') . $url, true);
		$data['delete'] = $this->url->link('localisation/language/delete', 'user_token=' . session('user_token') . $url, true);
		...
		foreach ($results as $result) {
			$data['languages'][] = array(
				...
				'edit'        => $this->url->link('localisation/language/edit', 'user_token=' . session('user_token') . '&language_id=' . $result['language_id'] . $url, true)
			);
		}
		...
		$data['sort_name'] = $this->url->link('localisation/language', 'user_token=' . session('user_token') . '&sort=name' . $url, true);
		$data['sort_code'] = $this->url->link('localisation/language', 'user_token=' . session('user_token') . '&sort=code' . $url, true);
		$data['sort_sort_order'] = $this->url->link('localisation/language', 'user_token=' . session('user_token') . '&sort=sort_order' . $url, true);
		...
		$pagination->url = $this->url->link('localisation/language', 'user_token=' . session('user_token') . $url . '&page={page}', true);
	...
	protected function getForm() {
		...
		if (!isset($this->request->get['language_id'])) {
			$data['action'] = $this->url->link('localisation/language/add', 'user_token=' . session('user_token') . $url, true);
		} else {
			$data['action'] = $this->url->link('localisation/language/edit', 'user_token=' . session('user_token') . '&language_id=' . $this->request->get['language_id'] . $url, true);
		}

		$data['cancel'] = $this->url->link('localisation/language', 'user_token=' . session('user_token') . $url, true);

		if (isset($this->request->get['language_id']) && (!request()->isMethod('POST'))) {
