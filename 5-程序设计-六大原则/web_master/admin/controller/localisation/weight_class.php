...
class ControllerLocalisationWeightClass extends Controller {
	...
	public function add() {
		...
		if ((request()->isMethod('POST')) && $this->validateForm()) {
			...
			$this->response->redirect($this->url->link('localisation/weight_class', 'user_token=' . session('user_token') . $url, true));
		}
	...
	protected function getList() {
		...
		$data['breadcrumbs'][] = array(
			...
			'href' => $this->url->link('localisation/weight_class', 'user_token=' . session('user_token') . $url, true)
		);

		$data['add'] = $this->url->link('localisation/weight_class/add', 'user_token=' . session('user_token') . $url, true);
		$data['delete'] = $this->url->link('localisation/weight_class/delete', 'user_token=' . session('user_token') . $url, true);
		...
		foreach ($results as $result) {
			$data['weight_classes'][] = array(
				...
				'unit'            => $result['unit'],
				'value'           => $result['value'],
				'edit'            => $this->url->link('localisation/weight_class/edit', 'user_token=' . session('user_token') . '&weight_class_id=' . $result['weight_class_id'] . $url, true)
			);
		}
		...
		$data['sort_title'] = $this->url->link('localisation/weight_class', 'user_token=' . session('user_token') . '&sort=title' . $url, true);
		$data['sort_unit'] = $this->url->link('localisation/weight_class', 'user_token=' . session('user_token') . '&sort=unit' . $url, true);
		$data['sort_value'] = $this->url->link('localisation/weight_class', 'user_token=' . session('user_token') . '&sort=value' . $url, true);
		...
		$pagination->url = $this->url->link('localisation/weight_class', 'user_token=' . session('user_token') . $url . '&page={page}', true);
	...
	protected function getForm() {
		...
		if (!isset($this->request->get['weight_class_id'])) {
			$data['action'] = $this->url->link('localisation/weight_class/add', 'user_token=' . session('user_token') . $url, true);
		} else {
			$data['action'] = $this->url->link('localisation/weight_class/edit', 'user_token=' . session('user_token') . '&weight_class_id=' . $this->request->get['weight_class_id'] . $url, true);
		}

		$data['cancel'] = $this->url->link('localisation/weight_class', 'user_token=' . session('user_token') . $url, true);

		if (isset($this->request->get['weight_class_id']) && (!request()->isMethod('POST'))) {
