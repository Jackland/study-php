...
class ControllerLocalisationTaxRate extends Controller {
	...
	public function add() {
		...
		if ((request()->isMethod('POST')) && $this->validateForm()) {
			...
			$this->response->redirect($this->url->link('localisation/tax_rate', 'user_token=' . session('user_token') . $url, true));
		}
	...
	protected function getList() {
		...
		$data['breadcrumbs'][] = array(
			...
			'href' => $this->url->link('localisation/tax_rate', 'user_token=' . session('user_token') . $url, true)
		);

		$data['add'] = $this->url->link('localisation/tax_rate/add', 'user_token=' . session('user_token') . $url, true);
		$data['delete'] = $this->url->link('localisation/tax_rate/delete', 'user_token=' . session('user_token') . $url, true);
		...
		foreach ($results as $result) {
			$data['tax_rates'][] = array(
				...
				'edit'          => $this->url->link('localisation/tax_rate/edit', 'user_token=' . session('user_token') . '&tax_rate_id=' . $result['tax_rate_id'] . $url, true)
			);
		}
		...
		$data['sort_name'] = $this->url->link('localisation/tax_rate', 'user_token=' . session('user_token') . '&sort=tr.name' . $url, true);
		$data['sort_rate'] = $this->url->link('localisation/tax_rate', 'user_token=' . session('user_token') . '&sort=tr.rate' . $url, true);
		$data['sort_type'] = $this->url->link('localisation/tax_rate', 'user_token=' . session('user_token') . '&sort=tr.type' . $url, true);
		$data['sort_geo_zone'] = $this->url->link('localisation/tax_rate', 'user_token=' . session('user_token') . '&sort=gz.name' . $url, true);
		$data['sort_date_added'] = $this->url->link('localisation/tax_rate', 'user_token=' . session('user_token') . '&sort=tr.date_added' . $url, true);
		$data['sort_date_modified'] = $this->url->link('localisation/tax_rate', 'user_token=' . session('user_token') . '&sort=tr.date_modified' . $url, true);
		...
		$pagination->url = $this->url->link('localisation/tax_rate', 'user_token=' . session('user_token') . $url . '&page={page}', true);
	...
	protected function getForm() {
		...
		if (!isset($this->request->get['tax_rate_id'])) {
			$data['action'] = $this->url->link('localisation/tax_rate/add', 'user_token=' . session('user_token') . $url, true);
		} else {
			$data['action'] = $this->url->link('localisation/tax_rate/edit', 'user_token=' . session('user_token') . '&tax_rate_id=' . $this->request->get['tax_rate_id'] . $url, true);
		}

		$data['cancel'] = $this->url->link('localisation/tax_rate', 'user_token=' . session('user_token') . $url, true);

		if (isset($this->request->get['tax_rate_id']) && (!request()->isMethod('POST'))) {
