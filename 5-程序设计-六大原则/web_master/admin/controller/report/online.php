...
class ControllerReportOnline extends Controller {
	public function index() {
		...
		$data['refresh'] = $this->url->link('report/online', 'user_token=' . session('user_token') . $url, true);
		...
		$pagination->url = $this->url->link('report/online', 'user_token=' . session('user_token') . $url . '&page={page}', true);
