...
/**
 * Class ModelCustomerCustomerGroup
 */
class ModelCustomerCustomerGroup extends Model {
     ...
     * @return mixed
     */
	public function getCustomerAccountingType(){
	    $query = $this->db->query('SELECT dc.DicKey AS type_id,dc.DicValue AS type_name FROM tb_sys_dictionary dc WHERE dc.DicCategory = \'ACCOUNTING_TYPE\'');
	    return $query->rows;
    }
}
