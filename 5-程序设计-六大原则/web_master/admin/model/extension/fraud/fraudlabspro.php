...
/**
 * Class ModelExtensionFraudFraudLabsPro
...
class ModelExtensionFraudFraudLabsPro extends Model {
	...
	public function addOrderHistory($order_id, $data, $store_id = 0) {
		...
		if (isset($this->session->data['cookie'])) {
            ...
            curl_setopt($curl, CURLOPT_USERAGENT, request()->serverBag->get('HTTP_USER_AGENT'));
			...
			curl_setopt($curl, CURLOPT_COOKIE, session_name() . '=' . session('cookie') . ';');
