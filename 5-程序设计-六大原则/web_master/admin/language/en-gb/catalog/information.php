...
$_['text_save_success']           = 'Success: You have created information!';
$_['text_list']              = 'Information List';
$_['text_add']               = 'Add Information';
$_['text_edit']              = 'Edit Information';
$_['text_default']           = 'Default';
$_['text_keyword']           = 'Do not use spaces, instead replace spaces with - and make sure the SEO URL is globally unique.';
$_['text_confirm_delete']           = 'When deleting the parent element, the child elements will be deleted. Are you sure?';
$_['text_remove_file_confirm']       = 'Are you sure to delete the file?';
...
$_['entry_parent']           = 'Parent Meta Title';
...
$_['error_meta_title']       = 'Meta Title must be greater than 1 and less than 64 characters!';
$_['error_meta_description']       = 'Meta Description must be greater than 1 and less than 255 characters!';
$_['error_meta_keyword']       = 'Meta Keyword must be greater than 1 and less than 64 characters!';
$_['error_keyword']          = 'SEO URL already in use!';
$_['error_sort_order']          = 'Sort Order must be >=0 or <=999!';
...
$_['error_country']          = 'Warning: Country can not be left blank!';
$_['error_roles']          = 'Role can not be left blank!';
$_['error_file_extension']   = 'Warning: Only supports uploading of PDF files!';
$_['error_file_necessary']   = 'Warning:When the Status field is set to Enabled,the File field cannot be empty!';
$_['error_file_other']       = 'Warning:File upload failed!';