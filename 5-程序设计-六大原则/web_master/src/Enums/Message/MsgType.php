...
class MsgType extends BaseEnum
{
    ...
    const PRODUCT_SUBSCRIBE = 109; // 订阅新产品
    const RMA = 200;
    const BID = 300;
    ...
    public static function getViewItems(): array
    {
        return [
            ...
            self::PRODUCT_SUBSCRIBE => 'New Arrivals',
            self::RMA => 'RMA',
            self::BID => 'Spot Price',
    ...
    /**
     * 获取Buyer-Product消息 其他类型
     *
     * @return array
     */
    public static function getBuyerProductOtherTypes()
    {
        return [
            self::PRODUCT,
            self::PRODUCT_STOCK,
     ...
     * @return array
     */
    public static function getBuyerProductTypes()
    {
        return [
            self::PRODUCT,
            self::PRODUCT_STOCK,
