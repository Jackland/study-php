...
trait RmaControllerTrait {
  ...
  private function validateAddRma() {
    ...
    if(!isset($this->request->post['order']) && !trim($this->request->post['order']) || utf8_strlen($this->request->post['order']) < 1) {
    ...
    if(utf8_strlen(trim($this->request->post['info'])) < 1 || utf8_strlen($this->request->post['info']) > 4000){
