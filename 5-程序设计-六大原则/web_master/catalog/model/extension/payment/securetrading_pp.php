...
/**
 * Class ModelExtensionPaymentSecureTradingPp
...
class ModelExtensionPaymentSecureTradingPp extends Model {
	...
	public function confirmOrder($order_id, $order_status_id, $comment = '', $notify = false) {
		...
		$this->db->query("UPDATE `" . DB_PREFIX . "order` SET order_status_id = ".OcOrderStatus::TO_BE_PAID." WHERE order_id = "  . (int)$order_id);
