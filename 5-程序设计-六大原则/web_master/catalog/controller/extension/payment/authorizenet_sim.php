...
class ControllerExtensionPaymentAuthorizeNetSim extends Controller {
	public function index() {
		...
		$data['x_fp_sequence'] = session('order_id');
		...
		$data['x_currency_code'] = session('currency');
		$data['x_invoice_num'] = session('order_id');
        ...
        $data['x_customer_ip'] = request()->serverBag->get('REMOTE_ADDR');
