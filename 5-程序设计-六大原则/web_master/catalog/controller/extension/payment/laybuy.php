...
class ControllerExtensionPaymentLaybuy extends Controller {
	...
	public function callback() {
		...
		if (request()->isMethod('POST') && isset($this->request->post['RESULT']) && $this->request->post['RESULT'] == 'SUCCESS') {
			$this->load->model('checkout/order');
		...
		} elseif (request()->isMethod('POST') && isset($this->request->post['RESULT']) && $this->request->post['RESULT'] == 'FAILURE') {
