...
class ControllerExtensionPaymentNochex extends Controller {
	public function index() {
		...
		$data['callback_url'] = $this->url->link('extension/payment/nochex/callback', 'order=' . session('order_id'), true);
	...
	public function callback() {
		...
		if (isset($this->request->get['method']) && $this->request->get['method'] == 'decline') {
			session()->set('error', $this->language->get('error_declined'));
		...
		if (!$order_info) {
			session()->set('error', $this->language->get('error_no_order'));
