...
/**
 * @property ModelExtensionPaymentSagePayDirect $model_extension_payment_sagepay_direct
 */
class ControllerExtensionCreditCardSagepayDirect extends Controller {
	...
	public function delete() {
		...
		if (!empty($card['token'])) {
			...
			if ($response_data['Status'] == 'OK') {
				...
				session()->set('success', $this->language->get('text_success_card'));
			} else {
				session()->set('error_warning', $this->language->get('text_fail_card'));
			}
		} else {
			session()->set('error_warning', $this->language->get('text_fail_card'));
		}
	...
	public function addCard() {
		...
		if ($response_data['Status'] == 'OK') {
			...
			session()->set('success', $this->language->get('text_success_add_card'));
		} else {
			session()->set('error_warning', $response_data['Status'] . ': ' . $response_data['StatusDetail']);
			$this->model_extension_payment_sagepay_direct->logger('Response data: ', session('error_warning'));
		}
