...
class ControllerProductManufacturer extends Controller {
	...
	public function info() {
		...
		if ($manufacturer_info) {
            ...
            $results = $this->model_catalog_product->getProductsBySearch($filter_data,$this->customer->getId(),$isPartner);
			//$results = $this->model_catalog_product->getProducts($filter_data,$customFields);
			...
			$limits = array_unique(array(16, 32, 64, 128));
            ...
            $data['products_to_csv'] = $this->url->link('/product/manufacturer/all_products_info&manufacturer_id='.$manufacturer_id);
            //$this->cache->set('product_total_str',$product_total_str);
            $this->session->data[$manufacturer_id]['manufacturer_product_total_str'] = $product_total_str;
    ...
    /**
     * [all_products_info description] 品牌
     */
    public function all_products_info(){
        ...
        $product_str = isset($this->request->get['product_str'])?$this->request->get['product_str']:null;
        if($type == 0 && null != $product_str){
            $product_total_str = $product_str;
        }else{

            if($this->session->data[$manufacturer_id]['manufacturer_product_total_str']){
                $product_total_str = $this->session->data[$manufacturer_id]['manufacturer_product_total_str'];
            }else{
