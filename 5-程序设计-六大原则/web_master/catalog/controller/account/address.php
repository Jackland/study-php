...
class ControllerAccountAddress extends Controller {
	...
	public function index() {
		if (!$this->customer->isLogged()) {
			session()->set('redirect', $this->url->link('account/address', '', true));
	...
	public function add() {
		...
		if ((request()->isMethod('POST')) && $this->validateForm()) {
			...
			session()->set('success', $this->language->get('text_add'));
	...
	public function edit() {
		...
		if ((request()->isMethod('POST')) && $this->validateForm()) {
			...
			if (isset($this->session->data['shipping_address']['address_id']) && ($this->request->get['address_id'] == $this->session->data['shipping_address']['address_id'])) {
				session()->set('shipping_address', $this->model_account_address->getAddress($this->request->get['address_id']));
			...
			if (isset($this->session->data['payment_address']['address_id']) && ($this->request->get['address_id'] == $this->session->data['payment_address']['address_id'])) {
				session()->set('payment_address', $this->model_account_address->getAddress($this->request->get['address_id']));

				$this->session->remove('payment_method');
				$this->session->remove('payment_methods');
			}

			session()->set('success', $this->language->get('text_edit'));
	...
	public function delete() {
		...
		if (isset($this->request->get['address_id']) && $this->validateDelete()) {
			...
			session()->set('success', $this->language->get('text_delete'));
	...
	protected function getForm() {
		...
		if (isset($this->request->get['address_id']) && (!request()->isMethod('POST'))) {
