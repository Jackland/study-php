	...
	public function save() {
		...
		if (!$json) {
			...
			if (isset($this->request->post['payment_address']) && $this->request->post['payment_address'] == 'existing') {
				...
				if (!$json) {
					session()->set('payment_address', $this->model_account_address->getAddress($this->request->post['address_id']));
				...
				if (!$json) {
					...
					session()->set('payment_address', $this->model_account_address->getAddress($address_id));
