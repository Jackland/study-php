	...
	public function save() {
		...
		if (!$json) {
			...
			if (isset($this->request->post['shipping_address']) && $this->request->post['shipping_address'] == 'existing') {
				...
				if (!$json) {
					session()->set('shipping_address', $this->model_account_address->getAddress($this->request->post['address_id']));
				...
				if (!$json) {
					...
					session()->set('shipping_address', $this->model_account_address->getAddress($address_id));
