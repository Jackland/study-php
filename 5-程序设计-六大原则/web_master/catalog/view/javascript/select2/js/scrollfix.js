(function ($) {
  $.fn.scrollFix = function (options) {
    return this.each(function () {
      ...
      var obj = $(this), base = this, selfTop = 0, selfLeft = 0, toTop = 0, parentOffsetLeft = 0, parentOffsetTop = 0,
        outerHeight, outerWidth, objWidth = 0, placeholder = jQuery('<div>'), optsTop = opts.distanceTop, endfix = 0;
      ...
      function resetScroll() {
        ...
        if (startBottom[0]) {
          var startBottomOffset = startBottom.offset(), startBottomPos = startBottomOffset.top,
