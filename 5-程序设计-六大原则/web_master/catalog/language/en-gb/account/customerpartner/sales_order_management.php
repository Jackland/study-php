...
$_['text_european_country_code_chart'] = 'European Country Code Chart';
...
$_['text_external_platform_mapping'] = 'Sales Order Upload';
$_['text_sales_order_city_comparison'] = 'City Comparison';
$_['text_sales_order_list'] = 'Sales Order List';
$_['text_sales_order_detail'] = 'Sales Order Details';
...
$_['text_has_no_fulfillment_fee_product'] = 'The fulfillment fee of this order exceeds the available asset amount.';
...
$_['text_error_release_inventory'] = 'Order cannot be released at this time, the inventory of the item is not enough to delivery, please check again!';
$_['text_error_release_international_order'] = ' The Sales Order cannot be released since it is not an International order and the Ship Country is incorrect, please check again.';
$_['text_error_release_international_size'] = 'The Sales Order cannot be released since the SKU [%s] size is incorrect in this International Order, please check again.';
$_['text_error_release_sku'] = 'The Sales Order cannot be released since the SKU [%s] in the uploaded file does not match with the seller’s SKU, please check again.';
...
$_['text_error_international_sales_order'] = 'An auto-generated fulfillment quote estimate is currently not available for the country selected. Please contact Customer Service for a fulfillment quote after successfully importing the sales order.';
$_['text_error_international_size'] = 'Not meeting the size standards of the International Order.';
...
$_['error_can_bp_fulfillment_fee'] = "The fulfillment fee of this order exceeds the monetary funds you have available.
                Your order has been placed on a temporary hold until payment has been completed. To continue shipping
                your goods as scheduled, please pay any outstanding fees and release the order on the Sales Order Management page.";
...
$_['text_order_confirm_ltl'] = 'Confirm LTL';
